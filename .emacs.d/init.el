...
;;Switching and movingg around windows
...
(use-package evil-tabs 
	:ensure t 
	:config  
	(define-key evil-tabs-mode-map (kbd "g-t") nil)  
	(define-key evil-tabs-mode-map (kbd "g-T") nil) 
;Already defined the movement keys to switch between tabs somewhere else
	) 
...
;;binding hot key for buffer list 
