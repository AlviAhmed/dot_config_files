...
;;    (cfw:ical-create-source "Moon" "~/moon.ics" "Gray")  ; ICS source1
    (cfw:ical-create-source "gcal" "https://calendar.google.com/calendar/ical/alvi.ahmed%40ryerson.ca/private-2dd2e7e146eb7a004400af04562036cf/basic.ics" "IndianRed") ; google calendar ICS
   ))) 


;; desktop save mode 
;;(desktop-save-mode 1) 
;;(add-hook  'desktop-read  'after-make-frame-functions)
...
;; -----------
;;(load-file "~/cedet-1.1/common/cedet.el") ;; CAN'T USE THIS LINE SINCE CEDET IS ALREADY LOADED
;; Enable EDE (Project Management) features
;; (global-ede-mode 1)
;; ;;(semantic-load-enable-excessive-code-helpers) ;; THIS VARIABLE IS VOID        
...
;; (add-hook 'java-mode-hook 'ede-minor-mode)
;; (add-hook 'c++-mode-hook 'ede-minor-mode)
;; (add-hook 'objc-mode-hook 'ede-minor-mode)
;; ;;some other mode I don't know  
;;;; (global-semantic-idle-scheduler-mode 1)   
...
(company-auctex-init) ;;automatically setups up a backend for company 

;; (global-company-fuzzy-mode 1)           ;adding fuzzy matching

(use-package irony 
	:ensure t 
	:config 
	(add-hook 'g++-mode-hook 'irony-mode)
...
(require 'yasnippet)
(yas-global-mode 1)  
;; fixing tab conflict with company
...
(add-hook 'prog-mode 'drag-stuff-mode)
(add-hook 'latex-mode 'drag-stuff-mode)
;;Drag Stuff
...
;;Enabling evil mode globally
(evil-mode 1)   

(global-evil-tabs-mode nil)  
...
;(define-key evil-normal-state-map (kbd "M-f") 'evil-force-normal-state) 
...
;; end evil mode key bindings 

;; begin Highlighting Symbols
(require 'highlight-symbol)
(global-set-key [(f6)] 'highlight-symbol)
(global-set-key [(f7)] 'highlight-symbol-next)
(global-set-key [(f8)] 'highlight-symbol-prev)
(global-set-key [(f9)] 'highlight-symbol-query-replace)
;; end Highlighting Symbols 



(which-key-mode)

;; begin general key bindings   
...
(global-set-key (kbd "M-4") 'dired-do-async-shell-command)  
...
(add-hook 'prog-mode-hook 'highlight-parentheses-mode)
;;Configuring highlight-indent-guides-mode 
