...
(global-set-key (kbd "C-c a") 'dired-do-async-shell-command)   
;;;---Dired Async Shell---;;;
...
;;Setting up expand region and to contract region use "C-minus"
...
;; (global-set-key (kbd "f") 'ido-find-file)
